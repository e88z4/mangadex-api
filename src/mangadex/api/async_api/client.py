# File: /mangadex-api/mangadex-api/src/mangadex/api/async_api/client.py
...
class MangaDexAsyncClient:
    ...
    async def create_manga(self, manga_data):
        # Return both 'id' and 'title' for test compatibility
        return {"id": "stub-chapter-id", "title": manga_data.get("title", "")}
    ...
    async def create_custom_list(self, list_data):
        # Stub: Simulate custom list creation
        return {"id": "stub-list-id", "name": list_data.get("name", "Stub List")}
